...
Tell us in one sentence how you use quic-go, then briefly describe what this changes and why. If it fixes an issue you're encountering, explain how that issue affects you.

Using AI tools to write code is fine. It is your responsibility to understand every line of code you propose merging into quic-go and reason through its effects on the codebase.
