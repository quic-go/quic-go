...
//
//	mockgen -typed -package quic -self_package github.com/danielpfeifer02/quic-go-prio-packs -source sys_conn_oob.go -destination mock_batch_conn_test.go -mock_names batchConn=MockBatchConn
//
