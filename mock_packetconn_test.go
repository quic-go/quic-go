...
//
//	mockgen -typed -package quic -self_package github.com/Noooste/uquic-go -self_package github.com/Noooste/uquic-go -destination mock_packetconn_test.go net PacketConn
//
