...
//
//	mockgen -typed -package quic -self_package github.com/danielpfeifer02/quic-go-prio-packs -self_package github.com/danielpfeifer02/quic-go-prio-packs -destination mock_packetconn_test.go net PacketConn
//
