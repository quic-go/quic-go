...
//
//	mockgen -typed -package quic -self_package github.com/Noooste/quic-go -self_package github.com/Noooste/quic-go -destination mock_packetconn_test.go net PacketConn
//
