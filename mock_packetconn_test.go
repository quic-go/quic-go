...
//
//	mockgen -typed -package quic -self_package github.com/Psiphon-Labs/quic-go -self_package github.com/Psiphon-Labs/quic-go -destination mock_packetconn_test.go net PacketConn
//
