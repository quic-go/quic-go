...
func setReceiveBuffer(c net.PacketConn) error {
	...
	if size >= protocol.DesiredReceiveBufferSize {
		islog.DefaultLogger.Debug("Conn has receive buffer", "size_kb", size/1024, "wanted_kb", protocol.DesiredReceiveBufferSize/1024)
		return nil
	}
	...
	islog.DefaultLogger.Debug("Increased receive buffer size", "size_kb", newSize/1024)
	return nil
}
