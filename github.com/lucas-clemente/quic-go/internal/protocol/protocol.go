...
// A PacketCount in QUIC
type PacketCount uint64
...
const MaxSegmentSize ByteCount = DefaultTCPMSS
...
// MaxTrackedPackets is the maximum number of tracked packets.
const MaxTrackedPackets PacketCount = 10000