...
// close closes the server. Transport.mutex *MUST NOT* be held while calling this method.
// This method closes any handshaking connections which requires the transport mutex.
