...
func newLostPacketTracker(maxLength int) *lostPacketTracker {
	return &lostPacketTracker{
		...
		// Hopefully we'll never lose many packets.
		lostPackets: make([]lostPacket, 0, 4),
	}
}

func (t *lostPacketTracker) Add(p protocol.PacketNumber, sendTime time.Time) {
...
func (t *lostPacketTracker) All() iter.Seq2[protocol.PacketNumber, time.Time] {
	return func(yield func(protocol.PacketNumber, time.Time) bool) {
...
func (t *lostPacketTracker) DeleteBefore(ti time.Time) {
