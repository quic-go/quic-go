...
func sendECNTestingPackets(t *testing.T, ecnTracker *ecnTracker, recorder *events.Recorder) {
	...
	require.Equal(t,
		[]qlog.Event{qlogevents.ECNStateUpdated{State: qlogevents.ECNStateTesting}},
		recorder.Events(),
	)
	require.Equal(t, protocol.ECT0, ecnTracker.Mode())
	recorder.Clear()
	...
	require.Equal(t,
		[]qlog.Event{qlogevents.ECNStateUpdated{State: qlogevents.ECNStateUnknown}},
		recorder.Events(),
	)
	recorder.Clear()
...
func TestECNTestingPacketsLoss(t *testing.T) {
	...
	require.Equal(t,
		[]qlog.Event{
			qlogevents.ECNStateUpdated{State: qlogevents.ECNStateFailed, Trigger: ecnFailedLostAllTestingPackets},
		},
...
func TestECNValidationInTestingState(t *testing.T) {
	...
	require.Equal(t,
		[]qlog.Event{qlogevents.ECNStateUpdated{State: qlogevents.ECNStateCapable}},
		eventRecorder.Events(),
	)
...
func testECNValidationFailure(
	...
	require.Equal(t,
		[]qlog.Event{qlogevents.ECNStateUpdated{State: qlogevents.ECNStateFailed, Trigger: expectedTrigger}},
		eventRecorder.Events(),
	)
}
...
func TestECNValidationNotEnoughECNCounts(t *testing.T) {
	...
	require.Equal(t,
		[]qlog.Event{qlogevents.ECNStateUpdated{State: qlogevents.ECNStateFailed, Trigger: ecnFailedTooFewECNCounts}},
		eventRecorder.Events(),
	)
}
...
func TestECNNonsensicalECNCountDecrease(t *testing.T) {
	...
	require.Equal(t,
		[]qlog.Event{qlogevents.ECNStateUpdated{State: qlogevents.ECNStateFailed, Trigger: ecnFailedDecreasedECNCounts}},
		eventRecorder.Events(),
	)
	eventRecorder.Clear()
...
func TestECNManglingAllPacketsMarkedCE(t *testing.T) {
	...
	require.Equal(t,
		[]qlog.Event{qlogevents.ECNStateUpdated{State: qlogevents.ECNStateFailed, Trigger: ecnFailedManglingDetected}},
		eventRecorder.Events(),
	)
}
