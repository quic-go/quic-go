...
// Source: github.com/Psiphon-Labs/quic-go (interfaces: Stream)
//
// Generated by this command:
//
//	mockgen -typed -build_flags=-tags=gomock -package mockquic -destination quic/stream.go github.com/Psiphon-Labs/quic-go Stream
//
