...
// Source: github.com/lucas-clemente/quic-go/http3 (interfaces: Stream)
...
func (m *MockStream) ReceiveMessage() ([]byte, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStreamMockRecorder) ReceiveMessage() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReceiveMessage", reflect.TypeOf((*MockStream)(nil).ReceiveMessage))
}

// SendMessage mocks base method.
func (m *MockStream) SendMessage(arg0 []byte) error {
	m.ctrl.T.Helper()
...
func (mr *MockStreamMockRecorder) SendMessage(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendMessage", reflect.TypeOf((*MockStream)(nil).SendMessage), arg0)
}
