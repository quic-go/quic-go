...
// Stub for BoringCrypto and FIPS mode - not supported in qtls fork
type boringStub struct {
	Enabled bool
}

var boring = boringStub{Enabled: false}

func (b boringStub) Unreachable() {
	// No-op stub
}

func (b boringStub) NewGCMTLS(cipher.Block) (cipher.AEAD, error) {
	panic("BoringCrypto not supported")
}

func (b boringStub) NewGCMTLS13(cipher.Block) (cipher.AEAD, error) {
	panic("BoringCrypto not supported")
}
...
type cipherSuiteTLS13 struct {
	...
	aead   func(key, fixedNonce []byte) aead
	hash   crypto.Hash
	KDFID  uint16 // For ECH support (stub)
	AEADID uint16 // For ECH support (stub)
}
...
var cipherSuitesTLS13 = []*cipherSuiteTLS13{ // TODO: replace with a map.
	{TLS_AES_128_GCM_SHA256, 16, aeadAESGCMTLS13, crypto.SHA256, 0, 0},
	{TLS_CHACHA20_POLY1305_SHA256, 32, aeadChaCha20Poly1305, crypto.SHA256, 0, 0},
	{TLS_AES_256_GCM_SHA384, 32, aeadAESGCMTLS13, crypto.SHA384, 0, 0},
}
