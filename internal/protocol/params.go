...
// DefaultAttackTimeout is the default timeout for a connection that receives a potentially malicious packet
const DefaultAttackTimeout = 0 * time.Millisecond
