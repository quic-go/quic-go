...
// Example: For a packet pacing delay of 10 microseconds, we would send 5 packets at once, wait for 50 microseconds, and so forth.
const MinPacingDelay time.Duration = 50 * time.Microsecond
