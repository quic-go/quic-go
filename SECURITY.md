...
a remote execution exploit -- please [**report privately**](https://github.com/Psiphon-Labs/quic-go/security/advisories/new).
...
For non-security bugs, please simply file a GitHub [issue](https://github.com/Psiphon-Labs/quic-go/issues/new).
