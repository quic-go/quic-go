...
quic-go is built so that, when used with a FIPS 140-3 validated Go Cryptographic Module (see [The FIPS 140-3 Go Cryptographic Module](https://go.dev/blog/fips140)), it should be ready for use in environments that require FIPS 140-3. quic-go does not seek separate FIPS 140-3 validation as a cryptographic module, and this document is not a compliance statement.
...
## QUIC operations relevant to FIPS 140
...
## QUIC operations not relevant to FIPS 140
