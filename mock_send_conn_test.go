...
//
//	mockgen -typed -build_flags=-tags=gomock -package quic -self_package github.com/Psiphon-Labs/quic-go -destination mock_send_conn_test.go github.com/Psiphon-Labs/quic-go SendConn
//
