...
func (mr *MockSendConnMockRecorder) Write(arg0, arg1 interface{}) *SendConnWriteCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Write", reflect.TypeOf((*MockSendConn)(nil).Write), arg0, arg1)
...
// Do rewrite *gomock.Call.Do
func (c *SendConnWriteCall) Do(f func([]byte, protocol.ByteCount) error) *SendConnWriteCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *SendConnWriteCall) DoAndReturn(f func([]byte, protocol.ByteCount) error) *SendConnWriteCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
