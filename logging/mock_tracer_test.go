...
func (mr *MockTracerMockRecorder) DroppedPacket(arg0, arg1, arg2, arg3 interface{}) *TracerDroppedPacketCall {
...
func (c *TracerDroppedPacketCall) Do(f func(net.Addr, PacketType, protocol.ByteCount, PacketDropReason)) *TracerDroppedPacketCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *TracerDroppedPacketCall) DoAndReturn(f func(net.Addr, PacketType, protocol.ByteCount, PacketDropReason)) *TracerDroppedPacketCall {
...
func (mr *MockTracerMockRecorder) SentPacket(arg0, arg1, arg2, arg3 interface{}) *TracerSentPacketCall {
	mr.mock.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *TracerSentPacketCall) Do(f func(net.Addr, *wire.Header, protocol.ByteCount, []Frame)) *TracerSentPacketCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *TracerSentPacketCall) DoAndReturn(f func(net.Addr, *wire.Header, protocol.ByteCount, []Frame)) *TracerSentPacketCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (mr *MockTracerMockRecorder) SentVersionNegotiationPacket(arg0, arg1, arg2, arg3 interface{}) *TracerSentVersionNegotiationPacketCall {
	mr.mock.ctrl.T.Helper()
