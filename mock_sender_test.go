...
func (mr *MockSenderMockRecorder) Send(arg0, arg1 interface{}) *SenderSendCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Send", reflect.TypeOf((*MockSender)(nil).Send), arg0, arg1)
...
// Do rewrite *gomock.Call.Do
func (c *SenderSendCall) Do(f func(*packetBuffer, protocol.ByteCount)) *SenderSendCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *SenderSendCall) DoAndReturn(f func(*packetBuffer, protocol.ByteCount)) *SenderSendCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
